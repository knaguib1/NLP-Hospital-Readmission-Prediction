# coding=utf-8
# This code is cloned from https://github.com/kexinhuang12345/clinicalBERT/blob/master/run_readmission.py
...
def main():
    ...
    # PATH = 'mymodel/pytorch_model_new_discharge_bal.bin'
    ...
    if args.do_train:
        ...
        with open('train_loss_history.json', 'w') as fout:
